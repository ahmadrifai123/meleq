...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create New Modul</li>
        </ol>
    </section>
    ...
    <section class="content">
        <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo base_url("index.php/backend/".$route."/store");?>">
              ...
              <h3 class="box-title">New Post </h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="judul" placeholder="">
                            </div>
