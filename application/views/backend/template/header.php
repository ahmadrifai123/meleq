...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <a href="index" class="logo">
      ...
      <span class="logo-lg"><img src="<?php echo base_url(); ?>assets/backend/dist/img/icon9.png" width="170" height="50"></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url('index.php/backend/login/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
